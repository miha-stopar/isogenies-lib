...
pub fn criterion_benchmark(cr: &mut Criterion) {
    ...
    let (a, b, c, f) = ec_lit128::get_params(128);
    let A = ec_lit128::Fq::ZERO;
    let curve = ec_lit128::Curve::new(&A);
    let lit_sigamal = ec_lit128::LITSiGamal::new(curve, p, 2, 3, 5, a, b, c, f, 3);
